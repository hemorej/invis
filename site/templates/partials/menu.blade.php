<body class="mw7 center bg-lightest-gray">
	<nav class="mt5-l pv4">
		<a class="ttl f3 f2-m f2-ns lh-title link black-70 hover-black-70 di-l db pv2-ns pa2 hover-bg-gold meta-cd" href="{{ url() }}" title="{{ html($site->title()) }}">{{ html($site->title()) }}</a>
