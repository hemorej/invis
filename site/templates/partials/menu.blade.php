<body class="mw7 center bg-lightest-gray">
	<nav class="mt5-l pv4 ttl s721-cd">
		...
		@if(!empty(kirby()->session()->get('txn')))
			<a class="{{ e($site->page()->title() == 'cart', 'bb b--gold bw2') }} pa1 link gray f5 f4-m f3-ns dib pv0 ml0-ns pa2-l hover-bg-gold hover-white" href="/prints/cart" title="cart">cart</a>
		@endif
	</nav>