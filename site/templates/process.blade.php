...
<nav class="mt4 ph2">
	...
	@endif
	<p class="fl">{{ e($page->hasPrevListed() && $page->hasNextListed(), '&nbsp;&vert;&nbsp;')}}<a class="f5 f4-m f4-ns link black-60 hover-white hover-bg-gold" href="{{ $page->parent()->url() }}">all posts</a></p>
