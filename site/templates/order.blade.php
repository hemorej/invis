...
@if($state == 'complete')
	...
	<div class="row medium-space-top">
		...
		<div class="small-12 medium-6 columns">
			...
			@php
				$customer = $order->customer()->toStructure();
...
@elseif($state == 'error')
	...
	<div class="row">
		<div class="small-12 medium-12 columns">
			...
			Please contact me with your session ID ({{ $kirby->session()->token() }}) at &#x6A;&#x65;&#x72;&#x6F;&#x6D;&#x65;&#x40;&#x74;&#x68;&#x65;&#x2D;&#x69;&#x6E;&#x76;&#x69;&#x73;&#x69;&#x62;&#x6C;&#x65;&#x2D;&#x63;&#x69;&#x74;&#x69;&#x65;&#x73;&#x2E;&#x63;&#x6F;&#x6D; to resolve this issue. 
		</div>
	</div>
@else
	@go('/prints')
