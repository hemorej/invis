...
It also includes a Stripe-backed print store and a double opt-in newsletter (subscriber emails are encrypted at rest, editions are sent from the Panel). See `CLAUDE.md` for the architecture.
